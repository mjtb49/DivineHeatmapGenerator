...
public class Main15 {
    ...
    public static void main(String[] args) {
        ...
        inputs.add(new FortressPanel());
        inputs.add(new PanelGroup(new GridLayout(4,1), new TreasurePanel(),new TreasurePanel(),new TreasurePanel(),new TreasurePanel()));
        inputs.add(new PanelGroup(new GridLayout(4,1), new ShipwreckPanel(),new ShipwreckPanel(),new ShipwreckPanel(),new ShipwreckPanel()));
        inputs.add(new PanelGroup(new GridLayout(4,1), new RuinPanel(),new RuinPanel(),new RuinPanel(),new RuinPanel()));

        //inputs.add(new TreePanel());
        //inputs.add(new AnimalPanel());
        ////misc overworld
        //inputs.add(new PanelGroup(new GridLayout(2,1), new DecoratorPanel("Pumpkin", 80007).chance(1/32.0f).call("x",true).call("z"), new DecoratorPanel("Desert Well", 40000).chance(1/1000.0f).call("x",16,true).call("z",16)));
        ////ocean stuff
        //inputs.add(new PanelGroup(new GridLayout(3,1), new DecoratorPanel("Iceberg", 20000).chance(1/16.0f).call("x",true).call("z"), new DecoratorPanel("Blue Iceberg", 20001).chance(1/200.0f).call("x",true).call("z"), new DecoratorPanel("Sea Pickle", 80011).chance(1/16.0f).call("x",true).call("z")));
        ////mushrooms
        //inputs.add(new PanelGroup(new GridLayout(2,1),new DecoratorPanel("Brown Mushroom", 80001).chance(1/4.0f).call("x",true).call("z"),new DecoratorPanel("Red Mushroom", 80002).chance(1/8.0f).call("x",true).call("z")));
        ////patches
        //inputs.add(new PanelGroup(new GridLayout(3,1),new DecoratorPanel("Gravel Patch", 60013).call("x",16).call("z",16,true).call("rad",4),new DecoratorPanel("Clay (Swamp)", 60011).call("x",16).call("z",16,true).call("rad",2),new DecoratorPanel("Clay (Other)", 60012).call("x",16).call("z",16,true).call("rad",2)));
